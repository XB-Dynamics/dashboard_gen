...
<body>
        <div id="splash-screen" style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: #000; z-index: 9999; display: flex; justify-content: center; align-items: center;">
        <video id="splash-video" autoplay muted style="max-width: 100%; max-height: 100%;">
    ...
    <div class="container">
        ...
        <div class="systems-container" id="systems-container">
            ...
            <div class="system-card system-4" data-system="system-4">
                ...
                <a href="mental-calculation.php" class="system-link">الدخول للنظام</a>
            </div>
        </div>
    ...
    <script>
        ...
        // عندما ينتهي الفيديو أو بعد 5 ثوانٍ
        video.addEventListener('ended', hideSplash);
        
        // ضبط مؤقت احتياطي لمدة 5 ثوانٍ
        setTimeout(hideSplash, 5000);
        
        function hideSplash() {
            // إخفاء شاشة الاسبيلاش
            ...
            // إزالة شاشة الاسبيلاش بعد انتهاء الانتقال
            setTimeout(() => {
                splashScreen.style.display = 'none';
            }, 500);
        }
        
        // إذا حدث خطأ في تحميل الفيديو
