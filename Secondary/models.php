...
<body>
    ...
    <div class="main-content">
        <div class="ai-models-container">
            ...
            <!-- نموذج الفيزياء -->
            <div class="ai-model-card" data-model="physics">
                <div class="icon-frame">
                    <div class="model-icon physics-model-bg">
                        <i class="fas fa-atom"></i>
                    </div>
                </div>
                <div class="model-title">نموذج الفيزياء</div>
                <div class="model-specialization">متخصص في مسائل الفيزياء</div>
                <div class="model-actions">
                    <a class="model-btn chat-btn" href="physics_chat.php">
                        <i class="fas fa-comments"></i> الذهاب للمحادثة
                    </a>
                </div>
            </div>
            ...
            <!-- نموذج الكيمياء -->
            <div class="ai-model-card" data-model="chemistry">
                <div class="icon-frame">
                    <div class="model-icon chemistry-model-bg">
                        <i class="fas fa-flask"></i>
                    </div>
                </div>
                <div class="model-title">نموذج الكيمياء</div>
                <div class="model-specialization">متخصص في مسائل الكيمياء</div>
                <div class="model-actions">
                    <a class="model-btn chat-btn" href="chemistry_chat.php">
                        <i class="fas fa-comments"></i> الذهاب للمحادثة
                    </a>
                </div>
            </div>
    ...
    <script>
                    ...
                    <div style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 10px; margin-bottom: 20px;">
                        ...
                        <div style="background: rgba(255,255,255,0.1); padding: 15px; border-radius: 8px; margin-bottom: 15px;">
                            ...
                            <select style="width: 100%; padding: 10px; border-radius: 5px; background: rgba(0,0,0,0.3); color: white; border: 1px solid var(--jet); margin-top: 10px;" id="pre-trained-models">
                                ...
                                <option>موديل الفيزياء المتقدم</option>
                                <option>موديل الكيمياء العضوية</option>
        ...
        function getModelName(model) {
            const names = {
                ...
                "my-model": "نماذجي",
                "physics": "نموذج الفيزياء",
                "chemistry": "نموذج الكيمياء", 
