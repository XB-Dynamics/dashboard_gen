    ...
    <div class="payment-container">
        ...
        <div class="payment-content">
            <div class="order-summary">
                <h2 class="order-title">ملخص الطلب</h2>
                
                <div class="order-item">
                    <span>الاشتراك الشهري</span>
                    <span>90 جنيه مصرى</span>
                </div>
                ...
                <div class="features-list">
                    <h3 style="color: #FFD93D; margin-bottom: 15px;">المزايا المشمولة:</h3>
            ...
            <div class="payment-methods">
                <h2 class="methods-title">اختر طريقة الدفع</h2>
            ...
            if (resultUrl.includes('success')) {
                fawaterkContainer.innerHTML = `
                    <div class="payment-success">
                        ...
                        <a href="index.php" class="action-btn">العودة للرئيسية</a>
                    </div>
                `;
