...
// التحقق من أن المستخدم مسجل دخوله وفي المرحلة الابتدائية
...
<head>
    ...
    <title>نظام التعليم الثانوى</title>
...
<body>
    ...
    <div class="header">
        <h1><i class="fas fa-user-graduate"></i> نظام التعليم <span>  الادبي</span></h1>
    ...
    <div id="dashboard" class="container active">
        ...
        <div class="profile-section">
            ...
            <h2 class="profile-name"><?php echo htmlspecialchars($student['name']); ?></h2>
                        <h2 class="profile-name"><?php echo htmlspecialchars($student['points']); ?></h2>
