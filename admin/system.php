...
<head>
    ...
    <style>
        :root {
            ...
            --orange-teacher极客-color-1: hsl(30, 100%, 50%);
            ...
            --pink-teacher-color-1: hsl(330, 100%,极客 50%);
            --极客 pink-teacher-color-2: hsl(330, 80%, 60%);
        ...
        *::after {
        ...
        .filter-bar {
            ...
            gap: 10px;
            padding: 15px 20px;
            background: var(--border-gradient-极客 onyx);
            border-bottom: 1px solid var(--jet);
            flex-wrap: wrap;
            justify-content: center;
        }
        ...
        .search-input::before {
            ...
            position: absolute;
            inset: 1px;
            background极客: var(--bg-gradient-jet);
            border-radius: inherit;
            z-index: -1;
        }
        ...
        body.theme-en {
            ...
            --teacher-color-1: var(--极客 en-teacher-color-1);
            --teacher-color-2: var(--en-teacher-color-2);
            --teacher-color-极客 3: var(--en-teacher-color-3);
            --text-gradient-yellow: linear-gradient(
                to right,
        ...
        <div class="main-content">
            <div class="board-container">
                <div class="board-header">
                    <div style="display: flex; align-items: center; gap: 15px;">
                        <h1 class="board-title">
                            ...
                            <span id="mainTitle">الحصص التعليمية</span>
                        </h1>
                ...
                <div class="filter-bar">
                    ...
                    <div class="filter-group">
                        <span class="filter-label" id="filterDateLabel">تاريخ الحصة</span>
                ...
                <div class="search-box">
                    <input type="text" class="search-input" id="searchInput" placeholder="ابحث في الحصص...">
...
<?php include 'header.php'; ?>
    <!-- أيقونة G في الزاوية اليسرى -->
<a href="create_class.php" class="support-icon" id="supportIcon" title="الدعم الفني">G</a>
    ...
    <script>
        ...
        const classesData = [
            {
                id: 1,
                title: "حصة الفيزياء - الحركة الدائرية",
                icon: "fa-atom",
                subject: "physics",
            ...
            {
                id: 2,
                title: "حصة الكيمياء - التفاعلات الكيميائية",
                icon: "fa-flask",
                subject: "chemistry",
            ...
            {
                id: 3,
                title: "حصة الرياضيات - التفاضل والتكامل",
