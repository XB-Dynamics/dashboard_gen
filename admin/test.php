...
<a href="tests.php" class="support-icon" id="supportIcon" title="الدعم الفني">G</a>
            ...
            exams.forEach(exam => {
                ...
                examCard.innerHTML = `
                    ...
                    <div class="exam-actions">
                        <a href="create_test.php" class="exam-action-btn action-start" data-exam-id="${exam.id}">
