...
<body>
    ...
    <div class="container">
            ...
            <div class="card ready-models">
                ...
                <div class="model-grid">
                    <div class="model-card">
                        <h3 class="model-title"><i class="fas fa-atom"></i> Physics Problem Solver</h3>
                        <div class="model-details">
                            <p>يحل مسائل فيزياء خطوة بخطوة مع رسومات توضيحية</p>
                            <ul>
                                <li>يدعم إدخال المسائل كنص أو صورة</li>
                                <li>يقدم حلولاً مفصلة مع شرح كل خطوة</li>
                                <li>يرسم diagrams توضيحية للقوى والحركات</li>
                                <li>يجيب على أسئلة الاستفسار حول الحل</li>
                            </ul>
                        </div>
                    </div>
                    
                    <div class="model-card">
                        <h3 class="model-title"><i class="fas fa-calculator"></i> Math Equations</h3>
                        <div class="model-details">
                    ...
                    <div class="model-card">
                        <h3 class="model-title"><i class="fas fa-vial"></i> Chemistry Interactive</h3>
                        <div class="model-details">
                            <p>موازنة معادلات كيميائية وشرح التفاعلات</p>
                            <ul>
                                <li>يوازن المعادلات الكيميائية تلقائياً</li>
                                <li>يشرح أنواع التفاعلات الكيميائية</li>
                                <li>يقدم معلومات عن العناصر والمركبات</li>
                                <li>يحلل نتائج التجارب الكيميائية</li>
                            </ul>
                        </div>
                    </div>
                    
                    <div class="model-card">
                        <h3 class="model-title"><i class="fas fa-language"></i> Grammar Corrector</h3>
                        <div class="model-details">
                    ...
                    <div class="model-card">
                        <h3 class="model-title"><i class="fas fa-pen-fancy"></i> Rhetoric Analysis</h3>
                        <div class="model-details">
        ...
        <a href="payment_page.php" class="btn-subscribe" id="subscribeBtn">
            <i class="fas fa-crown"></i> الاشتراك مقابل 90 جنيه مصرى
        </a>
    </div>
