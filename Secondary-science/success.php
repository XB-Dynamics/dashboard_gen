    ...
    <div class="container">
                    ...
                    <li class="feature-item">
                        <div class="feature-content">
                            ...
                            <div class="feature-text">
                                ...
                                <span>أسئلة صح أو خطأ مع تصحيح تلقائي</span>
                            </div>
                        </div>
                    </li>
                    <li class="feature-item">
                        <div class="feature-content">
                            ...
                            <div class="feature-text">
                                ...
                                <span>أسئلة مقالية مع تقييم متقدم</span>
                            </div>
                        </div>
                    </li>
                    <li class="feature-item">
                        <div class="feature-content">
                            ...
                            <div class="feature-text">
                                ...
                                <span>مؤقت زمني للاختبارات</span>
                            </div>
                        </div>
                    </li>
                </ul>
        ...
        <div class="content-section train-models">
            <div class="card train-models">
                <h2 class="card-title"><i class="fas fa-brain"></i> Train Models</h2>
                <p>تدريب نماذج الذكاء الاصطناعي على بياناتك الخاصة</p>
                    ...
                    <li class="feature-item">
                        <div class="feature-content">
                            ...
                            <div class="feature-text">
                                ...
                                <span>رفع بيانات التدريب المخصصة</span>
                            </div>
                        </div>
                    </li>
                    <li class="feature-item">
                        <div class="feature-content">
                            ...
                            <div class="feature-text">
                                ...
                                <span>اختيار النماذج المناسبة تلقائياً</span>
                            </div>
                        </div>
                    </li>
                </ul>
        ...
        <a href="payment_page.php" class="btn-subscribe" id="subscribeBtn">
            <i class="fas fa-crown"></i> الاشتراك مقابل 5 جنيه مصرى
        </a>
    </div>
