...
<body>
    ...
    <div class="main-content">
        <div class="ai-models-container">
            ...
            <!-- نموذج الرياضيات -->
            <div class="ai-model-card" data-model="sciences">
                <div class="icon-frame">
                    <div class="model-icon sciences-model-bg">
                        <i class="fas fa-calculator"></i>
                    </div>
                </div>
                <div class="model-title">نموذج العلوم</div>
                <div class="model-specialization">متخصص في مسائل العلوم</div>
                <div class="model-actions">
                    <a class="model-btn chat-btn" href="sciences.php">
                        <i class="fas fa-comments"></i> الذهاب للمحادثة
                    </a>
                </div>
            </div>
