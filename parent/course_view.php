        ...
        <div class="container">
            <!-- إضافة الأيقونات الجديدة هنا -->
              <div class="header-icons">
                <div class="header-icon" id="education-system" onclick="window.location.href='system.php';">
                    <i class="fas fa-graduation-cap"></i>
                    <span class="tooltip">النظام التعليمي</span>
                </div>
                    <div class="header-icon" id="reports"  onclick="window.location.href='index.php';">
    ...
    <div id="language-modal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="course_det.php" class="modal-link frontend" id="modal-link">الذهاب لدورة التعلم</a>
            </div>
        </div>
    </div>
