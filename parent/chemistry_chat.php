...
<head>
    ...
    <title>Genius AI - مساعد الكيمياء المتخصص</title>
    ...
    <style>
        ...
        *::after {
        ...
        @keyframes pulseBackground {
            0%, 100% { background-color: var(--jet); }
            50% { background-color: var(--onyx); }
        }
...
<body>
    ...
    <div class="symbol-keyboard" id="symbol-keyboard">
        ...
        <div class="keyboard-tabs">
            <button class="keyboard-tab active" data-tab="elements">العناصر</button>
            <button class="keyboard-tab" data-tab="symbols">رموز</button>
            <button class="keyboard-tab" data-tab="reactions">تفاعلات</button>
            <button class="keyboard-tab" data-tab="formats">تنسيق</button>
            <button class="keyboard-tab" data-tab="tools">أدوات</button>
        </div>
        <div class="keyboard-section active" id="elements-section">
            <!-- العناصر الكيميائية -->
            <button class="symbol-btn">H</button>
            <button class="symbol-btn">He</button>
            <button class="symbol-btn">Li</button>
            <button class="symbol-btn">Be</button>
            <button class="symbol-btn">B</button>
            <button class="symbol-btn">C</button>
            <button class="symbol-btn">N</button>
            <button class="symbol-btn">O</button>
            <button class="symbol-btn">F</button>
            <button class="symbol-btn">Ne</button>
            <button class="symbol-btn">Na</button>
            <button class="symbol-btn">Mg</button>
            <button class="symbol-btn">Al</button>
            <button class="symbol-btn">Si</button>
            <button class="symbol-btn">P</button>
            <button class="symbol-btn">S</button>
            <button class="symbol-btn">Cl</button>
            <button class="symbol-btn">K</button>
            <button class="symbol-btn">Ca</button>
            <button class="symbol-btn">Fe</button>
            <button class="symbol-btn">Cu</button>
            <button class="symbol-btn">Zn</button>
            <button class="symbol-btn">Ag</button>
            <button class="symbol-btn">Au</button>
            <button class="symbol-btn">Hg</button>
            <button class="symbol-btn">Pb</button>
            <button class="symbol-btn">U</button>
        </div>
        <div class="keyboard-section" id="symbols-section">
            <!-- الرموز الكيميائية -->
            ...
            <button class="symbol-btn">°</button>
            <button class="symbol-btn">α</button>
            <button class="symbol-btn">β</button>
            <button class="symbol-btn">γ</button>
            <button class="symbol-btn">π</button>
            <button class="symbol-btn">σ</button>
            <button class="symbol-btn">ρ</button>
            <button class="symbol-btn">λ</button>
            <button class="symbol-btn">μ</button>
            <button class="symbol-btn">ν</button>
            <button class="symbol-btn">ℏ</button>
            <button class="symbol-btn">≈</button>
            <button class="symbol-btn">≡</button>
            <button class="symbol-btn">∞</button>
            <button class="symbol-btn">∂</button>
        ...
        <div class="keyboard-section" id="reactions-section">
            <!-- رموز التفاعلات -->
            <button class="symbol-btn">⇄</button>
            <button class="symbol-btn">⇌</button>
            <button class="symbol-btn">⇋</button>
        ...
        <div class="keyboard-section" id="tools-section">
            <!-- أدوات مساعدة -->
            <button class="symbol-btn">pH</button>
            <button class="symbol-btn">pOH</button>
            <button class="symbol-btn">pKa</button>
            <button class="symbol-btn">pKb</button>
        ...
        <div class="chat-container">
            <div class="chat-header">
                ...
                <h2>
                    ...
                    Genius AI - مساعد الكيمياء المتخصص
                </h2>
            ...
            <div class="chat-input">
                <div class="input-group">
                    <textarea id="message-input" placeholder="اكتب سؤالك هنا عن الكيمياء..."></textarea>
    ...
    <script>
        ...
        function init() {
            ...
            setTimeout(() => {
                const greeting = "مرحباً! أنا مساعدك الذكي المتخصص في الكيمياء فقط من شركة Genius AI. يمكنك طرح أي سؤال في الكيمياء وسأساعدك في تحليله بدقة علمية. لدي معرفة متخصصة في: \n- التفاعلات الكيميائية \n- الجدول الدوري \n- الحسابات الكيميائية \n- التحاليل الكيميائية \n- المعادلات الكيميائية";
        ...
        function loadChatHistory() {
            const savedHistory = localStorage.getItem('chemistryGeniusHistory');
            if (savedHistory) {
        ...
        function saveChatHistory() {
            localStorage.setItem('chemistryGeniusHistory', JSON.stringify(chatHistory));
        }
        ...
        function showDeepThinkingIndicator() {
            ...
            deepThinking.innerHTML = `
                ...
                <p>جاري تحليل سؤالك الكيميائي بعمق...</p>
        ...
        // Process image with Gemini for chemical analysis
                ...
                reader.onload = async (e) => {
                        ...
                        contents: [
                            {
                                parts: [
                                    {
                                        text: question || "قم بتحليل هذه الصورة كيميائياً. اشرح أي معادلات كيميائية، عناصر، أو تفاعلات تظهر فيها. ركز فقط على الجوانب الكيميائية."
                                    },
                                    {
                                        inline_data: {
                    ...
                    try {
                        ...
                        if (data.candidates && data.candidates[0].content.parts[0].text) {
                            ...
                            resolve("عذرًا، لم أتمكن من تحليل الصورة كيميائياً. يرجى التأكد من أنها تحتوي على محتوى كيميائي واضح.");
                        }
                    } catch (error) {
                        console.error('Error processing image:', error);
                        resolve("حدث خطأ أثناء التحليل الكيميائي للصورة. يرجى المحاولة مرة أخرى.");
                    }
                };
        ...
        // Send text message to Gemini for chemistry questions
        async function sendTextMessage(message) {
            // Handle non-chemistry questions immediately
                ...
                contents: [
                    {
                        parts: [
                            {
                                text: "أنت مساعد ذكاء اصطناعي متخصص في الكيمياء فقط من شركة Genius AI. يجب أن تجيب على الأسئلة بدقة علمية في مجال الكيمياء فقط. لا تجب عن أسئلة في الفيزياء، الأحياء، أو أي مجال آخر. إذا سُئلت عن مجال آخر، قل: 'عذرًا، أنا متخصص في الكيمياء فقط. يمكنني مساعدتك في أي سؤال عن التفاعلات الكيميائية، العناصر، المعادلات، أو أي موضوع كيميائي آخر.' استخدم المصطلحات العلمية بدقة. إذا سُئلت عن هويتك، قل: 'أنا مساعد كيميائي من Genius AI، متخصص في تحليل المسائل الكيميائية.' يجب أن تكون الإجابة قصيرة (لا تتجاوز 70 كلمة). السؤال الكيميائي: " + message
                            }
                        ]
                    }
                ]
            ...
            try {
                ...
                if (data.candidates && data.candidates[0].content.parts[0].text) {
                    ...
                    return "عذرًا، لم أتمكن من معالجة سؤالك الكيميائي. يرجى التأكد من أنه يتعلق بالكيمياء فقط.";
                }
            } catch (error) {
                console.error('Error sending message:', error);
                return "حدث خطأ أثناء معالجة سؤالك الكيميائي. يرجى المحاولة مرة أخرى.";
            }
        }
        ...
        function handleSpecialQuestions(question) {
            ...
            // Check for images
            if (question.includes('صورة') || question.includes('رسم') || question.includes('صورة')) {
                return "عذرًا، أنا متخصص في تحليل النصوص الكيميائية فقط. لا يمكنني تحليل الصور.";
            }
            
            // ردود على أسئلة غير كيميائية
            if (lowerQuestion.includes('فيزياء') || lowerQuestion.includes('طبيعة') || lowerQuestion.includes('أحياء') || 
                lowerQuestion.includes('بيولوجيا') || lowerQuestion.includes('علم الأحياء') || lowerQuestion.includes('حركة') ||
                lowerQuestion.includes('قوة') || lowerQuestion.includes('سرعة') || lowerQuestion.includes('ضوء') ||
                lowerQuestion.includes('صوت') || lowerQuestion.includes('كهرباء') || lowerQuestion.includes('مغناطيسية') ||
                lowerQuestion.includes('رياضيات') || lowerQuestion.includes('هندسة') || lowerQuestion.includes('طب') ||
                lowerQuestion.includes('علوم') || lowerQuestion.includes('جيولوجيا') || lowerQuestion.includes('فلك')) {
                return "عذرًا، أنا متخصص في الكيمياء فقط من شركة Genius AI. لا يمكنني الإجابة على أسئلة خارج مجال الكيمياء. يمكنك طرح أي سؤال عن الكيمياء وسأسعد بمساعدتك.";
            }
            ...
            if (lowerQuestion.includes('من أنت') || lowerQuestion.includes('من صنعك') || 
                ...
                return "أنا مساعد كيميائي متخصص من شركة Genius AI. تم تدريبي على تحليل المسائل الكيميائية فقط. لا أعتمد على أي واجهات برمجية خارجية. أنا نموذج مستقل تم تطويره خصيصاً للكيمياء.";
            }
        ...
        async function handleSend() {
            ...
            if (file) {
                ...
                reader.onload = (e) => {
                    ...
                    const userMessage = addMessage("صورة للتحليل الكيميائي:", true);
            ...
            let response;
            if (file) {
                response = "عذرًا، أنا متخصص في تحليل النصوص الكيميائية فقط. لا يمكنني تحليل الصور.";
            } else {
        ...
        // Handle deep think with extended animations for chemical analysis
        async function handleDeepThink() {
            ...
            if (file) {
                ...
                reader.onload = (e) => {
                    ...
                    const userMessage = addMessage("صورة للتحليل الكيميائي المتعمق:", true);
                    userMessage.appendChild(imgPreview);
                };
                reader.readAsDataURL(file);
            }
            ...
            // Process message with longer delay for deep chemical analysis
            setTimeout(async () => {
                let response;
                if (file) {
                    response = "عذرًا، أنا متخصص في تحليل النصوص الكيميائية فقط. لا يمكنني تحليل الصور.";
                } else {
                    response = await sendTextMessage(message + " (قم بتحليل هذا السؤال الكيميائي بتعمق مع ذكر النظريات والمعادلات ذات الصلة)");
                }
                
                // Remove thinking indicator and show response
                chatMessages.removeChild(thinkingIndicator);
                addMessage(response);
            }, 10000); // 10 seconds delay for deep chemical thinking
        }
        ...
        function handleVoiceInput() {
            if ('webkitSpeechRecognition' in window) {
                ...
                recognition.onstart = function() {
                    ...
                    listeningIndicator.innerHTML = '<i class="fas fa-microphone"></i> جاري الاستماع إلى سؤالك الكيميائي...';
                ...
                recognition.onerror = function(event) {
                    ...
                    errorMessage.textContent = 'حدث خطأ في التعرف على سؤالك الكيميائي. يرجى المحاولة مرة أخرى.';
        ...
        function resetVoiceButton() {
            ...
            voiceBtn.style.boxShadow = 'var(--shadow3)';
            messageInput.placeholder = "اكتب سؤالك هنا عن الكيمياء...";
        }
