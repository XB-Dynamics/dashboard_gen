...
$class_name = 'ولي  ' . $academic_year . ' الامر';
...
<body>
    <div class="header">
        <h1><i class="fas fa-user-graduate"></i> لوحه تحكم <span>ولي الامر</span></h1>
        <div class="header-controls">
    <a href="report.info.php" class="social-icon">
    ...
    <a href="index.php" class="social-icon">
        <i class="fas fa-user-tie profile-icon"></i>
            ...
            <a href="logout.php" class="logout-btn" onclick="logout()">
    ...
    <script>
        // Toggle sub icons
        document.getElementById('main-icon').addEventListener('click', function(e) {
            e.stopPropagation();
        ...
        document.getElementById('sub-icons').addEventListener('click', function(e) {
            e.stopPropagation();
        });
        ...
        // فتح السوشيال ميديا
        function openReport(platform, pageTitle) {
