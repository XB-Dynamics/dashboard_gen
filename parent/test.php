        ...
        <div class="main-content">
            <div class="board-container">
                <div class="board-header">
                    <div style="display: flex; align-items: center; gap: 15px;">
                        <h1 class="board-title">
                            ...
                            <span id="mainTitle">الاختبارات الذكية</span>
                        </h1>
                ...
                <div class="filter-bar">
                    ...
                    <div class="filter-group">
                        <span class="filter-label" id="filterDateLabel">تاريخ الامتحان</span>
                ...
                <div class="search-box">
                    <input type="text" class="search-input" id="searchInput" placeholder="ابحث في الاختبارات...">
...
<a href="create_test.php" class="support-icon" id="supportIcon" title="الدعم الفني">G</a>

    <script>
        // بيانات الاختبارات (كل التواريخ ماضية)
        const examsData = [
            {
                id: 1,
                title: "امتحان الفيزياء - الحركة الدائرية",
                icon: "fa-atom",
                subject: "physics",
                description: "اختبار في قوانين الحركة الدائرية وتطبيقاتها العملية",
                date: "15 يناير 2023"
            },
            {
                id: 2,
                title: "امتحان الكيمياء - التفاعلات الكيميائية",
                icon: "fa-flask",
                subject: "chemistry",
                description: "اختبار في أنواع التفاعلات الكيميائية وموازنة المعادلات",
                date: "22 فبراير 2023"
            },
            {
                id: 3,
                title: "امتحان الرياضيات - التفاضل والتكامل",
                icon: "fa-square-root-alt",
                subject: "math",
                description: "اختبار في أساسيات التفاضل والتكامل وحل المسائل",
                date: "10 مارس 2023"
            },
        ];
        ...
        function renderExams(exams) {
            ...
            exams.forEach(exam => {
                ...
                examCard.innerHTML = `
                    <i class="fas ${exam.icon} exam-icon"></i>
                    ...
                    <div class="exam-actions">
                        <a href="#" class="exam-action-btn action-start" data-exam-id="${exam.id}">
                            <i class="fas fa-play"></i>
                            <span>${currentLanguage === 'ar' ? 'بدء الاختبار' : 'Start Exam'}</span>
                        </a>
                    </div>
                `;
                
                // حدث النقر على زر بدء الاختبار
                examCard.querySelector('.action-start').addEventListener('click', (e) => {
                    e.preventDefault();
                    const message = currentLanguage === 'ar' 
                        ? `سيتم بدء الاختبار: ${exam.title}` 
                        : `Exam will start: ${exam.title}`;
                    alert(message);
                    // هنا يمكنك إضافة التوجيه إلى صفحة الاختبار الفعلية
                });
        ...
        function toggleLanguage() {
            ...
            if (currentLanguage === 'en') {
                ...
                mainTitle.textContent = 'Smart Exams';
                searchInput.placeholder = 'Search exams...';
                document.getElementById('filterSubjectLabel').textContent = 'Subject';
                document.getElementById('filterDateLabel').textContent = 'Exam Date';
                document.getElementById('navExams').textContent = 'Exams';
                document.getElementById('navModules').textContent = 'Models';
                document.getElementById('navClasses').textContent = 'Classes';
                ...
                document.querySelector('#dateFilter option[value="recent"]').textContent = 'Recent';
                document.querySelector('#dateFilter option[value="oldest"]').textContent = 'Oldest';
            } else {
                ...
                mainTitle.textContent = 'الاختبارات الذكية';
                searchInput.placeholder = 'ابحث في الاختبارات...';
                document.getElementById('filterSubjectLabel').textContent = 'المادة الدراسية';
                document.getElementById('filterDateLabel').textContent = 'تاريخ الامتحان';
                document.getElementById('navExams').textContent = 'الاختبارات';
                document.getElementById('navModules').textContent = 'الموديلات';
                document.getElementById('navClasses').textContent = 'حصصي';
                ...
                document.querySelector('#dateFilter option[value="recent"]').textContent = 'الأحدث';
                document.querySelector('#dateFilter option[value="oldest"]').textContent = 'الأقدم';
            }
            
            // إعادة تصفية وعرض الاختبارات لتحديث النصوص
            filterExams();
        }
