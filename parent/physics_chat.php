...
<head>
    ...
    <title>Genius AI - مساعد الفيزياء المتخصص</title>
    ...
    <style>
        ...
        *::after {
        ...
        .chat-input textarea:focus {
            ...
            box-shadow: 0 0 0 3px hsla(45, 100%, 72%, 0.3);
        }
...
<body>
    ...
    <div class="symbol-keyboard" id="symbol-keyboard">
        ...
        <div class="keyboard-tabs">
            <button class="keyboard-tab active" data-tab="mechanics">الميكانيكا</button>
            <button class="keyboard-tab" data-tab="electricity">الكهرباء</button>
            <button class="keyboard-tab" data-tab="thermodynamics">الديناميكا</button>
            <button class="keyboard-tab" data-tab="formats">تنسيق</button>
            <button class="keyboard-tab" data-tab="tools">أدوات</button>
        </div>
        <div class="keyboard-section active" id="mechanics-section">
            <!-- رموز الميكانيكا -->
            <button class="symbol-btn">F</button>
            <button class="symbol-btn">m</button>
            <button class="symbol-btn">a</button>
            <button class="symbol-btn">v</button>
            <button class="symbol-btn">p</button>
            <button class="symbol-btn">t</button>
            <button class="symbol-btn">s</button>
            <button class="symbol-btn">g</button>
            <button class="symbol-btn">ω</button>
            <button class="symbol-btn">α</button>
            <button class="symbol-btn">τ</button>
            <button class="symbol-btn">I</button>
            <button class="symbol-btn">L</button>
            ...
            <button class="symbol-btn">η</button>
            <button class="symbol-btn">σ</button>
            <button class="symbol-btn">ε</button>
        ...
        <div class="keyboard-section" id="electricity-section">
            <!-- رموز الكهرباء والمغناطيسية -->
            <button class="symbol-btn">Q</button>
            <button class="symbol-btn">q</button>
            <button class="symbol-btn">E</button>
            <button class="symbol-btn">V</button>
            <button class="symbol-btn">I</button>
            <button class="symbol-btn">R</button>
        ...
        <div class="keyboard-section" id="thermodynamics-section">
            <!-- رموز الديناميكا الحرارية -->
            <button class="symbol-btn">T</button>
            <button class="symbol-btn">P</button>
            <button class="symbol-btn">V</button>
            <button class="symbol-btn">n</button>
            <button class="symbol-btn">Q</button>
            <button class="symbol-btn">W</button>
            ...
            <button class="symbol-btn">κ</button>
        ...
        <div class="chat-container">
            <div class="chat-header">
                ...
                <h2>
                    ...
                    Genius AI - مساعد الفيزياء المتخصص
                </h2>
            ...
            <div class="chat-input">
                <div class="input-group">
                    <textarea id="message-input" placeholder="اكتب سؤالك هنا عن الفيزياء..."></textarea>
    ...
    <script>
        ...
        function init() {
            ...
            setTimeout(() => {
                const greeting = "مرحباً! أنا مساعدك الذكي المتخصص في الفيزياء فقط من شركة Genius AI. يمكنك طرح أي سؤال في الفيزياء وسأساعدك في تحليله بدقة علمية. لدي معرفة متخصصة في: \n- الميكانيكا الكلاسيكية \n- الكهرباء والمغناطيسية \n- الديناميكا الحرارية \n- الفيزياء الحديثة \n- الفيزياء الكمية";
        ...
        function loadChatHistory() {
            const savedHistory = localStorage.getItem('physicsGeniusHistory');
            if (savedHistory) {
        ...
        function saveChatHistory() {
            localStorage.setItem('physicsGeniusHistory', JSON.stringify(chatHistory));
        }
        ...
        function showDeepThinkingIndicator() {
            ...
            deepThinking.innerHTML = `
                <i class="fas fa-brain"></i>
                <p>جاري تحليل سؤالك الفيزيائي بعمق...</p>
        ...
        // Process image with Gemini for physics analysis
                ...
                reader.onload = async (e) => {
                        ...
                        contents: [
                            {
                                parts: [
                                    {
                                        text: question || "قم بتحليل هذه الصورة فيزيائياً. اشرح أي معادلات، قوانين، أو ظواهر فيزيائية تظهر فيها. ركز فقط على الجوانب الفيزيائية."
                                    },
                                    {
                                        inline_data: {
                    ...
                    try {
                        ...
                        if (data.candidates && data.candidates[0].content.parts[0].text) {
                            ...
                            resolve("عذرًا، لم أتمكن من تحليل الصورة فيزيائياً. يرجى التأكد من أنها تحتوي على محتوى فيزيائي واضح.");
                        }
                    } catch (error) {
                        console.error('Error processing image:', error);
                        resolve("حدث خطأ أثناء التحليل الفيزيائي للصورة. يرجى المحاولة مرة أخرى.");
                    }
                };
        ...
        // Send text message to Gemini for physics questions
        async function sendTextMessage(message) {
            // Handle non-physics questions immediately
                ...
                contents: [
                    {
                        parts: [
                            {
                                text: "أنت مساعد ذكاء اصطناعي متخصص في الفيزياء فقط من شركة Genius AI. يجب أن تجيب على الأسئلة بدقة علمية في مجال الفيزياء فقط. لا تجب عن أسئلة في الكيمياء، الأحياء، أو أي مجال آخر. إذا سُئلت عن مجال آخر، قل: 'عذرًا، أنا متخصص في الفيزياء فقط. يمكنني مساعدتك في أي سؤال عن الميكانيكا، الكهرباء، الديناميكا الحرارية، أو أي موضوع فيزيائي آخر.' استخدم المصطلحات العلمية بدقة. إذا سُئلت عن هويتك، قل: 'أنا مساعد فيزيائي من Genius AI، متخصص في تحليل المسائل الفيزيائية.' يجب أن تكون الإجابة قصيرة (لا تتجاوز 70 كلمة). السؤال الفيزيائي: " + message
                            }
                        ]
                    }
                ]
            ...
            try {
                ...
                if (data.candidates && data.candidates[0].content.parts[0].text) {
                    ...
                    return "عذرًا، لم أتمكن من معالجة سؤالك الفيزيائي. يرجى التأكد من أنه يتعلق بالفيزياء فقط.";
                }
            } catch (error) {
                console.error('Error sending message:', error);
                return "حدث خطأ أثناء معالجة سؤالك الفيزيائي. يرجى المحاولة مرة أخرى.";
            }
        }
        ...
        function handleSpecialQuestions(question) {
            ...
            if (question.includes('صورة') || question.includes('رسم') || question.includes('صورة')) {
                return "عذرًا، أنا متخصص في تحليل النصوص الفيزيائية فقط. لا يمكنني تحليل الصور.";
            }
            
            // ردود على أسئلة غير فيزيائية
            if (lowerQuestion.includes('كيمياء') || lowerQuestion.includes('تفاعل') || lowerQuestion.includes('عنصر') || 
                lowerQuestion.includes('جدول دوري') || lowerQuestion.includes('مركب') || lowerQuestion.includes('جزيء') ||
                lowerQuestion.includes('أحياء') || lowerQuestion.includes('بيولوجيا') || lowerQuestion.includes('علم الأحياء') ||
                ...
                return "عذرًا، أنا متخصص في الفيزياء فقط من شركة Genius AI. لا يمكنني الإجابة على أسئلة خارج مجال الفيزياء. يمكنك طرح أي سؤال عن الفيزياء وسأسعد بمساعدتك.";
            }
            ...
            if (lowerQuestion.includes('من أنت') || lowerQuestion.includes('من صنعك') || 
                ...
                return "أنا مساعد فيزيائي متخصص من شركة Genius AI. تم تدريبي على تحليل المسائل الفيزيائية فقط. لا أعتمد على أي واجهات برمجية خارجية. أنا نموذج مستقل تم تطويره خصيصاً للفيزياء.";
            }
        ...
        async function handleSend() {
            ...
            if (file) {
                ...
                reader.onload = (e) => {
                    ...
                    const userMessage = addMessage("صورة للتحليل الفيزيائي:", true);
            ...
            let response;
            if (file) {
                response = "عذرًا، أنا متخصص في تحليل النصوص الفيزيائية فقط. لا يمكنني تحليل الصور.";
            } else {
        ...
        // Handle deep think with extended animations for physics analysis
        async function handleDeepThink() {
            ...
            if (file) {
                ...
                reader.onload = (e) => {
                    ...
                    const userMessage = addMessage("صورة للتحليل الفيزيائي المتعمق:", true);
                    userMessage.appendChild(imgPreview);
                };
                reader.readAsDataURL(file);
            }
            ...
            // Process message with longer delay for deep physics analysis
            setTimeout(async () => {
                let response;
                if (file) {
                    response = "عذرًا، أنا متخصص في تحليل النصوص الفيزيائية فقط. لا يمكنني تحليل الصور.";
                } else {
                    response = await sendTextMessage(message + " (قم بتحليل هذا السؤال الفيزيائي بتعمق مع ذكر القوانين والنظريات ذات الصلة)");
                }
                
                // Remove thinking indicator and show response
                chatMessages.removeChild(thinkingIndicator);
                addMessage(response);
            }, 10000); // 10 seconds delay for deep physics thinking
        }
        ...
        function handleVoiceInput() {
            if ('webkitSpeechRecognition' in window) {
                ...
                recognition.onstart = function() {
                    ...
                    listeningIndicator.innerHTML = '<i class="fas fa-microphone"></i> جاري الاستماع إلى سؤالك الفيزيائي...';
                ...
                recognition.onerror = function(event) {
                    ...
                    errorMessage.textContent = 'حدث خطأ في التعرف على سؤالك الفيزيائي. يرجى المحاولة مرة أخرى.';
        ...
        function resetVoiceButton() {
            ...
            voiceBtn.style.background = 'var(--bg-gradient-onyx)';
            voiceBtn.style.boxShadow = 'var(--shadow1)';
            messageInput.placeholder = "اكتب سؤالك هنا عن الفيزياء...";
        }
